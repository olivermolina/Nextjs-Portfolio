...
import {DiCss3, DiSwift, DiVisualstudio,} from "react-icons/di";
import {IoLogoJavascript, IoLogoSlack} from "react-icons/io";
import {FaFigma, FaReact, FaTrello} from "react-icons/fa";
...
export const TECHNOLOGIES = [
	{
		category: "Mobile",
		items: [{name: "React Native", icon: <RiReactjsFill size={32}/>}, {name: "Swift", icon: <DiSwift size={32}/>}]
	},
	{
		category: "Front-end",
		items: [
	...
	},
	{
		...
		items: [
			...
			{name: "Slack", icon: <IoLogoSlack width={32}/>},
